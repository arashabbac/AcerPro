...
using AcerPro.Common.ViewModels;
...
public class CanNotUpdateCustomerWithDuplicateEmail : IClassFixture<TestingWebAppFactory<Program>>
{
    ...
    {
        var customer1 = new RegisterUserFormViewModel
        {
        ...
        var newCustomer = new RegisterUserFormViewModel
        {
            Firstname = Faker.Name.First(),
            Lastname = Faker.Name.Last(),
            DateOfBirth = Faker.Identification.DateOfBirth(),
    ...
    {
        var customerViewModel = new RegisterUserFormViewModel
        {
            Firstname = Faker.Name.First(),
            Lastname = Faker.Name.Last(),
            DateOfBirth = Faker.Identification.DateOfBirth(),
